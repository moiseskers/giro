...
@Component({
    ...
    template: `
        ...
        >
            <div class="p-checkbox p-component" [ngClass]="{ 'p-variant-filled': varInputStyle() === 'filled' }">
                <div class="p-checkbox-box" [ngClass]="{ 'p-highlight': selected }">
                    <ng-container *ngIf="selected">
                        <CheckIcon *ngIf="!checkIconTemplate && !itemCheckboxIconTemplate"
                                   [styleClass]="'p-checkbox-icon'" [attr.aria-hidden]="true"/>
...
export class MultiSelectItem {
    ...
    varInputStyle = signal<'outlined' | 'filled'>('outlined');
                            ...
                            <ng-template #builtInFilterElement>
                                <div
                                        ...
                                        *ngIf="isSelectionAllDisabled()"
                                        [ngClass]="{ 'p-variant-filled': variant === 'filled' || inputStyle() === 'filled', 'p-checkbox-disabled': disabled }"
                                ...
                                >
                                    ...
                                    <div
                                            ...
                                            [ngClass]="{ 'p-highlight': allSelected(), 'p-focus': headerCheckboxFocus, 'p-disabled': disabled }"
                                    >
...
export class MultiSelect implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    ...
    get containerClass() {
        return {
            ...
            'p-variant-filled': this.variant === 'filled' || this.inputStyle() === 'filled'
        };
    }

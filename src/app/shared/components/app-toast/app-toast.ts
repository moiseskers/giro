...
@Component({
    ...
    template: `
        <div #container [attr.id]="message.id" [class]="message.styleClass"
            ...
            <div class="p-toast-message-content" role="alert" aria-live="assertive" aria-atomic="true"
                ...
                <ng-container *ngIf="!template">
                    ...
                    <div class="p-toast-message-text">
                        ...
                        <ng-container *ngIf="isHtml;else defaultTemplate">
                ...
                <button type="button" class="p-toast-icon-close p-link" (click)="onCloseIconClick($event)"
                        (keydown.enter)="onCloseIconClick($event)" *ngIf="message.closable !== false" pRipple>
...
@Component({
    ...
    template: `
        <div #container [ngClass]="'p-toast p-component p-toast-' + position" [ngStyle]="style" [class]="styleClass">
            <p-toastItem
                    [isHtml]="isHtml"
                    *ngFor="let msg of messages; let i=index" [message]="msg" [index]="i"
                    (onClose)="onMessageClose($event)" [template]="template" @toastAnimation
                    (@toastAnimation.start)="onAnimationStart($event)" (@toastAnimation.done)="onAnimationEnd($event)"
...
export class AppToast implements OnInit, AfterContentInit, OnDestroy {
...
@NgModule({
    ...
    exports: [AppToast, SharedModule],
    declarations: [AppToast, ToastItem]
})

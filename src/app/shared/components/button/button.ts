        ...
        >
            ...
            <ng-container *ngIf="loading">
                <ng-container *ngIf="!loadingIconTemplate">
                    ...
                    <SpinnerIcon *ngIf="!loadingIcon" [styleClass]="spinnerIconClass()" class="mr-2" [spin]="true" [attr.aria-hidden]="true" [attr.data-pc-section]="'loadingicon'" />
                </ng-container>
            ...
            <ng-container *ngIf="!loading">
                ...
                <span *ngIf="materialIcon && !iconTemplate" [ngClass]="iconClass()" class="pi material-symbols-outlined">{{materialIcon}}</span>
...
export class Button implements AfterContentInit {
    ...
    @Input() disabledOutlined: boolean | undefined;
    /**
     * Whether the button is in loading state.
     * @group Props
     */
    ...
    get buttonClass() {
        return {
            ...
            'p-disabled-outlined': this.disabledOutlined || this.loading,

...
@Component({
    ...
    template: `
        <span
            ...
            [ngStyle]="style"
            class="app-p-calendar-input-container"
            [class]="styleClass"
        >
...
<!--                          class="p-datepicker-trigger p-button-icon-only bg-transparent border-right-0" -->
<!--                          [disabled]="disabled"-->
<!--                          tabindex="0"-->
<!--                  >-->
<!--                    <span *ngIf="icon" [ngClass]="icon"></span>-->
<!--                    <ng-container *ngIf="!icon">-->
<!--                        <span class="pi material-icons-outlined" style="color: var(&#45;&#45;surface-300)">calendar_today</span>-->
<!--                    </ng-container>-->
<!--                </button>-->
                       <div class="pi material-symbols-outlined app-p-calendar-icon">
                     calendar_today
                 </div>
                ...
                <input
                    ...
                    ? 
                    'p-inputtext p-component ng-invalid ng-touched ng-dirty' : 
...
export class Calendar implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    constructor(
        ...
        @Inject(DOCUMENT) private document: Document, public el: ElementRef, public renderer: Renderer2, public cd: ChangeDetectorRef, private zone: NgZone, private config: PrimeNGConfig, public overlayService: OverlayService) {

...
import { GoalsTonsPageComponent } from './pages/goals-tons-page.component';
import { GoalAchievementStatusContainerComponent } from './containers/goal-achievement-status-container/goal-achievement-status-container.component';
import { ManagementBackyardContainerComponent } from '../producer-goals-tons/containers/management-backyard-container/management-backyard-container.component'
...
@NgModule({
    ...
    providers: [ProduderGoalsTonsService],
})
export class ProducerGoalsTonsModule {}

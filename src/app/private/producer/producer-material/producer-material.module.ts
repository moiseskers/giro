...
import {ProducerMaterialPageComponent} from './pages/material-page/producer-material-page.component';
...
import {
    ProducerMaterialMediaLinkListContainerComponent
} from './containers/producer-material-media-link-list-container/producer-material-media-link-list-container.component';
import {
    ProducerMaterialDocumentListContainerComponent
} from './containers/producer-material-document-list-container/producer-material-document-list-container.component';
import {
...
export const routes: Routes = [
    {
        path: '',
        component: ProducerMaterialPageComponent,
    },
];
...
export class ProducerMaterialModule {
}

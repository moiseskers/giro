...
@Component({
    selector: 'app-manager-view-organization',
    templateUrl: './manager-view-organization.component.html',
    styleUrl: './manager-view-organization.component.scss'
})
export class ManagerViewOrganizationComponent {

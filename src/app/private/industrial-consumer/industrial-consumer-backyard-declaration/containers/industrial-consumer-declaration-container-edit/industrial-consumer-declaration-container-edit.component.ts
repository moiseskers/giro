...
@Component({
    selector: 'app-industrial-consumer-declaration-container-edit',
    templateUrl: './industrial-consumer-declaration-container-edit.component.html',
    styleUrl: './industrial-consumer-declaration-container-edit.component.scss'
})
export class IndustrialConsumerDeclarationContainerEditComponent {

...
import {
    IndustrialConsumerViewOrganizationComponent
} from "./pages/organization-view/industrial-consumer-view-organization.component";
...
export const routes: Routes = [
    {
        path: 'view/:id',
        component: IndustrialConsumerViewOrganizationComponent,
    },
];

@NgModule({
  declarations: [IndustrialConsumerViewOrganizationComponent],
    imports: [
        CommonModule,
...
export class IndustrialConsumerOrganizationModule {

...
@Component({
    selector: 'app-industrial-consumer-material-document-list-container',
    templateUrl: './industrial-consumer-material-document-list-container.component.html',
    styleUrl: './industrial-consumer-material-document-list-container.component.scss'
})
export class IndustrialConsumerMaterialDocumentListContainerComponent {

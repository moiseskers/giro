...
@Component({
    selector: 'app-declaration-history-list-container',
    templateUrl: './declaration-history-list-container.component.html',
    styleUrl: './declaration-history-list-container.component.scss'
})
export class DeclarationHistoryListContainerComponent {

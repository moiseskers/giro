...
@Component({
    selector: 'app-declaration-container-edit',
    templateUrl: './declaration-container-edit.component.html',
    styleUrl: './declaration-container-edit.component.scss'
})
export class DeclarationContainerEditComponent {

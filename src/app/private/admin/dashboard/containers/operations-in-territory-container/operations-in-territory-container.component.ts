...
@Component({
    selector: 'app-operations-in-territory-container',
    templateUrl: './operations-in-territory-container.component.html',
    styleUrl: './operations-in-territory-container.component.scss'
})
export class OperationsInTerritoryContainerComponent {
    ...
    updateCards(routes: number, cleanPoints: number, houses: number) {
        this.totalRoutes = routes || 0;
        this.totalCleanPoints = cleanPoints || 0;
        this.totalHouses = houses || 0;
    }

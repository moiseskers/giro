...
@Component({
    selector: 'app-bidding-page-list',
    templateUrl: './bidding-list-page.component.html',
    styleUrl: './bidding-list-page.component.scss'
})
export class BiddingListPageComponent {
    ...
    public readonly viewPageUrl: string = `/private/admin/bidding/pages/view`;
    ...
    cancel(): Promise<any> {
        return new Promise(resolve => {
            this.ref = this.dialogService.open(CancelBiddingFormComponent, {
                header: 'Cancelación de licitación',
                width: '40vw',
                modal: true,
                breakpoints: {
                    '960px': '75vw',

...
@Component({
    selector: 'app-city-view-organization',
    templateUrl: './city-view-organization.component.html',
    styleUrl: './city-view-organization.component.scss'
})
export class CityViewOrganizationComponent {

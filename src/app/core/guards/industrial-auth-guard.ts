...
export const IndustrialAuthGuard: CanActivateFn = async (next: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
    ...
    if (roleService.hasAnyRole(roles, [Role.INDUSTRIAL_CONSUMER])) {
        return true;
    } else {
